...
<!--------------------------------------------------------------------------------- End of Common --------------------------------------------------->	
			...
			<div id="Table1">
			<h3> Our Mission </h3>
			<p> Our mission is to provide world class car rental services with prices that compete with the ones offered by 'around the corner' local rental car providers. </p>
			</div>
			
			<div id="Table2">
			<h3> Our Services </h3>
			<p> Through extensive use of technology, we keep our operating costs low to provide excellent services, and pass on the savings to our customers. Please <a href="contact.php">
			<span class="auto-style14">Contact</span></a> Us to learn more.</p>
			</div>
			
			<div id="Table3">
			<h3> Why SuperRent ? </h3>
			<p>SuperRent Rental Car guarantee to provide both on-road and online safety for our customers. For on-road safety, we provide new, clean,and well maintained cars.</p>
			</div>
